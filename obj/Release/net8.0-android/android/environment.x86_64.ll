...
@dso_cache = dso_local local_unnamed_addr global [604 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 2366028849025114421, ; hash 0x20d5d2b3d277e135, from name: libaot-GroceryAPP
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 3118431973790932189, ; hash 0x2b46e55ba6075cdd, from name: GroceryAPP.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GroceryAPP.dll.so
		ptr null; void* handle (0x0)
	}, ; 101
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.73_name, ; name: libaot-System.IO.Pipes.dll.so
		ptr null; void* handle (0x0)
	}, ; 143
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 5826372002629196158, ; hash 0x50db6e7789fe997e, from name: aot-GroceryAPP.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GroceryAPP.dll.so
		ptr null; void* handle (0x0)
	}, ; 176
	...
	%struct.DSOCacheEntry {
		i64 9675736398016434152, ; hash 0x86471efd60164fe8, from name: GroceryAPP
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GroceryAPP.dll.so
		ptr null; void* handle (0x0)
	}, ; 314
	...
	%struct.DSOCacheEntry {
		i64 13747063671746595152, ; hash 0xbec761930b220950, from name: libaot-GroceryAPP.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GroceryAPP.dll.so
		ptr null; void* handle (0x0)
	}, ; 456
	...
	%struct.DSOCacheEntry {
		i64 15652385441635264585, ; hash 0xd93871a1182a6849, from name: aot-GroceryAPP
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GroceryAPP.dll.so
		ptr null; void* handle (0x0)
	}, ; 519
...
@.env.3 = private unnamed_addr constant [37 x i8] c"57dd8c46-8bbd-4c8a-8fbe-f6f7eac89c5a\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [27 x i8] c"com.companyname.groceryapp\00", align 16
...
@.DSOCacheEntry.73_name = private unnamed_addr constant [30 x i8] c"libaot-System.IO.Pipes.dll.so\00", align 16
