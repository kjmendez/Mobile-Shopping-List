...
@dso_cache = dso_local local_unnamed_addr global [604 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 355083348, ; hash 0x152a2454, from name: libaot-GroceryAPP
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 422197973, ; hash 0x192a3ad5, from name: aot-GroceryAPP
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GroceryAPP.dll.so
		ptr null; void* handle (0x0)
	}, ; 53
	...
	%struct.DSOCacheEntry {
		i64 1207659504, ; hash 0x47fb6bf0, from name: GroceryAPP.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GroceryAPP.dll.so
		ptr null; void* handle (0x0)
	}, ; 149
	...
	%struct.DSOCacheEntry {
		i64 2008881842, ; hash 0x77bd1ab2, from name: GroceryAPP
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GroceryAPP.dll.so
		ptr null; void* handle (0x0)
	}, ; 266
	...
	%struct.DSOCacheEntry {
		i64 3331966423, ; hash 0xc699c5d7, from name: libaot-GroceryAPP.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GroceryAPP.dll.so
		ptr null; void* handle (0x0)
	}, ; 472
	...
	%struct.DSOCacheEntry {
		i64 3718124591, ; hash 0xdd9e142f, from name: aot-GroceryAPP.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GroceryAPP.dll.so
		ptr null; void* handle (0x0)
	}, ; 523
