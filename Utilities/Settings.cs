...
using GroceryAPP.Resources.Styles;
#if __ANDROID__
using Android.OS;
...
namespace GroceryAPP.Utilities
{
    public static class Settings
    {
        ...
        public static ObservableCollection<GroceryAPP.Models.Theme> GetAllThemesAsCollection()
        {
            var themes = new ObservableCollection<GroceryAPP.Models.Theme>
        {
